...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	СтоимостьЧаса = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Договор, "ВКМ_СтоимостьЧасаРаботы");
	...
	Для Каждого Строка из ВыполненныеРаботы Цикл
		ЧасыКОплатеКлиенту = ЧасыКОплатеКлиенту + Строка.ЧасыКОплатеКлиенту;
	КонецЦикла;
	...
	Движение.Период = Дата;
	Движение.ВКМ_Сотрудник = Специалист;
...
Функция ВыбранДействующийДоговорАбонентскогоОбслуживания()
	...
	ВидДоговораВДокументе = Договор.ВидДоговора;
	...
	КонецЕсли;
	ПериодДоговора = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Договор, "ВКМ_ДействуетС, ВКМ_ДействуетПо");
