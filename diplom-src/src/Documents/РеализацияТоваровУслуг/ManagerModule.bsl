...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если ПечатнаяФорма <> Неопределено Тогда
	    ПечатнаяФорма.ТабличныйДокумент = ВКМ_ПечатьАктаОказанныхУслуг(МассивОбъектов, ОбъектыПечати);
...
Функция ВКМ_ПечатьАктаОказанныхУслуг(МассивОбъектов, ОбъектыПечати)
	...
	Пока ДанныеДокументов.Следующий() Цикл
		...
		ВКМ_ВывестиЗаголовокАктаОказанныхУслуг(ДанныеДокументов, ТабличныйДокумент, Макет);
		...
		ВКМ_ВывестиПодвалАктаОказанныхУслуг(ДанныеДокументов, ТабличныйДокумент, Макет);
...
Процедура ВКМ_ВывестиЗаголовокАктаОказанныхУслуг(ДанныеДокументов, ТабличныйДокумент, Макет)
...
Процедура ВКМ_ВывестиПодвалАктаОказанныхУслуг(ДанныеДокументов, ТабличныйДокумент, Макет)
